...
# === /users — Now shows total unique users ever ===
@bot.message_handler(commands=['users'])
def users_cmd(m):
    bot.reply_to(m, f"**Total unique users ever:** `{len(TOTAL_USERS)}`", parse_mode='Markdown')
